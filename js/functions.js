...
// and stores it in a variable named random
    ...
    alert("Welcome to tip calculation!");

    var bill = Number(prompt("What is the total?"));
    var tip = Number(prompt("How much would you like to tip?"));
    var tipPercentage = tip / 100;

    console.log(calculateTip(tipPercentage, bill));
    alert("Your tip will be $" + calculateTip(tipPercentage, bill).toFixed(2));
    ...
    alert("Discount calculator!");
    var price = Number(prompt("What is the total today?"));
    var discount = Number(prompt("How much is your discount?"));
